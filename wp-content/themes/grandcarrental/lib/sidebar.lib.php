...
function grandcarrental_register_sidebars() 
{
	...
	if ( function_exists('register_sidebar') )
	    register_sidebar(array('id' => 'single-tour-sidebar', 'name' => 'Single Car Sidebar', 'description' => 'The default sidebar for single car page'));
...
add_action( 'widgets_init', 'grandcarrental_register_sidebars' );
