...
//Get all car brands
$car_brands_select = array();
$car_brands_select[''] = '';

if($grandcarrental_custom_post_activated)
{
	$car_brands_arr = get_terms('carbrand', 'hide_empty=0&hierarchical=0&parent=0&orderby=menu_order');
	
	foreach ($car_brands_arr as $car_brand) {
		$car_brands_select[$car_brand->name] = $car_brand->name;
	}
}

//Get all car types
$car_types_select = array();
$car_types_select[''] = '';

if($grandcarrental_custom_post_activated)
{
	$car_types_arr = get_terms('cartype', 'hide_empty=0&hierarchical=0&parent=0&orderby=menu_order');
	
	foreach ($car_types_arr as $car_type) {
		$car_types_select[$car_type->name] = $car_type->name;
	}
}
...
$car_order_select = grandcarrental_get_sort_options();
...
$ppb_shortcodes = array(
    ...
    'ppb_header' => array(
    	...
    	'attr' => array(
    		...
    		'margin' => array(
    			...
    			'type' => 'margin',
    			"std" => "0",
    			'desc' => 'Enter margin value for this block',
    		),
    		'custom_css' => array(
    			'title' => 'Custom Style',
    			'type' => 'text',
    ...
    'ppb_car_search' => array(
    	...
    	'attr' => array(
    		...
    		'url' => array(
    			'title' => 'Car Page URL',
    			'type' => 'text',
    			'desc' => 'Enter URL of tour page you want to display this search result (*page must be car page template)',
    		),
    		'margin' => array(
    			'title' => 'Content Margin',
    			'type' => 'margin',
    ...
    'ppb_car_search_background' => array(
    	'title' =>  'Car Search With Background Image',
    	'icon' => 'image_full_popup.png',
    	'image' => 'car_search_background.jpg',
    	'attr' => array(
    		'slug' => array(
    			'title' => 'Slug (Optional)',
    			'type' => 'text',
    		...
    		'url' => array(
    			'title' => 'Car Page URL',
    			'type' => 'text',
    			'desc' => 'Enter URL of car page you want to display this search result (*page must be car page template)',
    		),
    		'height' => array(
    			'title' => 'Height',
    			'type' => 'jslider',
    ...
    'ppb_car_search_youtube' => array(
    	'title' =>  'Car Search With Parallax Youtube Video',
    	'icon' => 'image_full_popup.png',
    	'image' => 'car_search_youtube.jpg',
    	'attr' => array(
    		'slug' => array(
    			'title' => 'Slug (Optional)',
    			'type' => 'text',
    ...
    'ppb_car_search_vimeo' => array(
    	'title' =>  'Car Search With Parallax Vimeo Video',
    	'icon' => 'image_full_popup.png',
    	'image' => 'car_search_vimeo.jpg',
    	'attr' => array(
    		'slug' => array(
    			'title' => 'Slug (Optional)',
    			'type' => 'text',
    ...
    'ppb_car_classic' => array(
    	'title' =>  'Car Classic',
    	'icon' => 'portfolio_classic.png',
    	'image' => 'car_classic.jpg',
    	'attr' => array(
    		'slug' => array(
    			'title' => 'Slug (Optional)',
    			'type' => 'text',
    		...
    		'carbrand' => array(
    			'title' => 'Filter By Car Brand (Optional)',
    			'type' => 'select',
    			'options' => $car_brands_select,
    			'desc' => 'Select to car brand you want to filter',
    		),
    		'cartype' => array(
    			'title' => 'Filter By Car Type (Optional)',
    			'type' => 'select',
    			'options' => $car_types_select,
    			'desc' => 'Select to car type you want to filter',
    		),
    		'columns' => array(
    			'title' => 'Columns',
    			'type' => 'select',
    		...
    		'order' => array(
    			'title' => 'Order By',
    			'type' => 'select',
    			'options' => $car_order_select,
    			'desc' => 'Select how you want to order car items',
    		),
    		'items' => array(
    			'type' => 'jslider',
    			"std" => "9",
    ...
    'ppb_car_grid_sidebar' => array(
    	'title' =>  'Car Grid Sidebar',
    	'icon' => 'gallery_grid.png',
    	'image' => 'car_grid_sidebar.jpg',
    	'attr' => array(
    		'slug' => array(
    			'title' => 'Slug (Optional)',
    			'type' => 'text',
    ...
    'ppb_car_classic_sidebar' => array(
    	'title' =>  'Car Classic Sidebar',
    	'icon' => 'portfolio_classic.png',
    	'image' => 'car_classic_sidebar.jpg',
    	'attr' => array(
    		'slug' => array(
    			'title' => 'Slug (Optional)',
    			'type' => 'text',
    ...
    'ppb_car_brand_grid' => array(
    	'title' =>  'Car Brand Grid',
    	'icon' => 'gallery_grid.png',
    	'image' => 'car_brand.jpg',
    	'attr' => array(
    		'slug' => array(
