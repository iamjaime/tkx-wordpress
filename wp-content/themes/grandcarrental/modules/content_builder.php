...
function grandcarrental_content_create_meta_box() {

	$grandcarrental_page_postmetas = grandcarrental_get_page_postmetas();
	
	if ( function_exists('add_meta_box') && isset($grandcarrental_page_postmetas) && count($grandcarrental_page_postmetas) > 0 ) {  
		add_meta_box( 'content_metabox', 'Content Builder Option', 'grandcarrental_content_new_meta_box', 'page', 'normal', 'high' );
		add_meta_box( 'content_metabox', 'Content Builder Option', 'grandcarrental_content_new_meta_box', 'portfolios', 'normal', 'high' );
	}

} 

function grandcarrental_content_new_meta_box() {
	$grandcarrental_page_postmetas = grandcarrental_get_page_postmetas();
...
?>
	...
	<div id="ppb_page_content">
		<div class="ppb_page_title_bar">
			<div class="ppb_page_title">
				<a id="ppb_open_dev_bar" title="<?php esc_html_e('Open Developer View', 'grandcarrental' ); ?>"><span class="dashicons dashicons-list-view"></span></a>
				
				<a id="ppb_open_templates" href="#ppb_template" class="pp_fancybox_inline"><?php esc_html_e('Templates', 'grandcarrental' ); ?></a>
				
				<a id="ppb_preview_page" data-action="<?php echo esc_url(admin_url('admin-ajax.php?action=grandcarrental_ppb_preview_page_set_data')); ?>" data-preview="<?php echo esc_url(admin_url('admin-ajax.php?action=grandcarrental_ppb_preview_page&ppb_post_type=page&page_id='.$post->ID)); ?>" data-page="<?php echo esc_attr($post->ID); ?>"><?php esc_html_e('Preview', 'grandcarrental' ); ?></a>
			...
			<div class="ppb_page_action">
				<a id="ppb_undo" title="<?php esc_html_e('Undo', 'grandcarrental' ); ?>"><span class="dashicons dashicons-undo"></span></a>
				
				<a id="ppb_redo" title="<?php esc_html_e('Redo', 'grandcarrental' ); ?>"><span class="dashicons dashicons-redo"></span></a>
			
				<a id="ppb_page_unsaved" class="tooltipster" title="<?php echo esc_html__('Unsaved Page Content.', 'grandcarrental' ); ?>"><span class="dashicons dashicons-info"></span></a>
			
				<a id="ppb_live" title="<?php esc_html_e('Live View', 'grandcarrental' ); ?>"><span class="dashicons dashicons-desktop"></span></a>
				
				<a id="ppb_classic" title="<?php esc_html_e('Classic View', 'grandcarrental' ); ?>"><span class="dashicons dashicons-editor-insertmore"></span></span></a>
				
				<a id="ppb_add" title="<?php esc_html_e('Add Content', 'grandcarrental' ); ?>"><span class="dashicons dashicons-plus"></span></a>
				
				<a id="ppb_save" title="<?php esc_html_e('Saved', 'grandcarrental' ); ?>" data-saved-title="<?php esc_html_e('Saved', 'grandcarrental' ); ?>" data-save-title="<?php esc_html_e('Save Changes', 'grandcarrental' ); ?>" href="<?php echo esc_url(admin_url('admin-ajax.php?action=grandcarrental_ppb_save_page_builder&page_id='.$post->ID)); ?>" class="inactive"><span class="dashicons dashicons-download"></span><span class="ppb_live_button_title"><?php esc_html_e('Saved', 'grandcarrental' ); ?></span></a>
				
				<a href="<?php echo GRANDCARRENTAL_BUILDERDOCURL; ?>" target="_blank" id="ppb_help" title="<?php esc_html_e('Content Builder Documentation', 'grandcarrental' ); ?>"><span class="dashicons dashicons-editor-help"></span></a>
			</div>
		</div>
		<br class="clear"/>
	...
	<div id="ppb_page_title_header">
		<div class="ppb_page_title_wrapper">
			<div class="ppb_page_sub_title"><?php esc_html_e('You are editing', 'grandcarrental' ); ?></div>
	...
	?>
	    	<li id="<?php echo esc_attr($ppb_form_item); ?>" class="ui-state-default <?php echo esc_attr($ppb_form_item_size[0]); ?> <?php echo esc_attr($ppb_form_item_data_obj->shortcode); ?>" data-current-size="<?php echo esc_attr($ppb_form_item_size[0]); ?>" data-shortcode="<?php echo esc_attr($ppb_shortocde_title); ?>" data-icon="<?php echo esc_url($ppb_shortcode_icon); ?>">
	    		<div class="size">
	    			<a href="javascript:;" title="<?php esc_html_e('Increase Size', 'grandcarrental' ); ?>" class="ppb_plus button">+</a>
	    			<a href="javascript:;" title="<?php esc_html_e('Decrease Size', 'grandcarrental' ); ?>" class="ppb_minus button">-</a>
	    		</div>
	    		...
	    		<div class="item_action">
	    			<a href="javascript:;" class="ppb_remove" title="<?php esc_html_e('Remove', 'grandcarrental' ); ?>"><i class="fa fa-trash"></i></a>
					
					<a href="javascript:;" class="ppb_duplicate" title="<?php esc_html_e('Duplicate', 'grandcarrental' ); ?>"><i class="fa fa-copy"></i></a>
					
					<a data-rel="<?php echo esc_attr($ppb_form_item); ?>" href="<?php echo esc_url(admin_url('admin-ajax.php?action=grandcarrental_ppb&ppb_post_type=page&shortcode='.$ppb_form_item_data_obj->shortcode.'&rel='.$ppb_form_item.'&width=800&height=900&page_id='.$post->ID)); ?>" class="ppb_edit" title="<?php esc_html_e('Edit', 'grandcarrental' ); ?>"><i class="fa fa-edit"></i></a>
					
					<a data-rel="<?php echo esc_attr($ppb_form_item); ?>" href="javascript:;" class="ppb_add_after" title="<?php esc_html_e('Add Content After This', 'grandcarrental' ); ?>"><i class="fa fa-plus"></i></a>
	    		</div>
	...
	<div id="ppb_add_content_wrapper" <?php if(!empty($count_ppb)) { ?>class="not_started"<?php } ?>>
	    ...
	    <div id="ppb_add_content_wrapper_started">
	    	<h2><?php esc_html_e('Get started', 'grandcarrental' ); ?></h2>
	    	<div class="ppb_tagline"><?php esc_html_e('Currently you have no content. Start adding content by clicking button below', 'grandcarrental' ); ?></div>
	    </div>
	    <?php
	    	}
	    ?>
	    
	    <a id="ppb_sortable_add_button" href="#ppb_tab" class="pp_fancybox_inline_fullheight" data-after=""!><i class="fa fa-plus-circle"></i><?php esc_html_e('Add Content', 'grandcarrental' ); ?></a>
	    ...
	    <?php
	    	...
	    	{
	    ?>
	    <a id="ppb_sortable_template_button" href="#ppb_template" class="pp_fancybox_inline"><i class="fa fa-cloud-download"></i><?php esc_html_e('Import Template', 'grandcarrental' ); ?></a>
	    <?php
	    	}
	    ?>
	</div>
	...
	<div id="ppb_import_tab">
	    <ul>
	    	<li><a href="#tabs-import"><?php esc_html_e('Import', 'grandcarrental' ); ?></a></li>
	    	<li><a href="#tabs-export"><?php esc_html_e('Export', 'grandcarrental' ); ?></a></li>
	    </ul>
	    
	    <div id="tabs-import">
	    	<strong><?php esc_html_e('Import Page Content Builder', 'grandcarrental' ); ?></strong>
	    	<div class="pp_widget_description"><?php esc_html_e('Choose the import file. *Note: Your current content builder content will be overwritten by imported data', 'grandcarrental' ); ?></div><br/>
	    ...
	    <div id="tabs-export">
	    	<strong><?php esc_html_e('Export Current Page Content Builder', 'grandcarrental' ); ?></strong>
	    	<div class="pp_widget_description"><?php esc_html_e('Click to export current content builder data. *Note: Please make sure you save all changes and no "unsaved" module', 'grandcarrental' ); ?></div><br/>
	...
	?>
	    	jQuery(window).bind('beforeunload', function(){
	    		...
	    		{
	    	    	return '<?php esc_html_e('There are unsaved content builder settings', 'grandcarrental' ); ?>';
	    	    }
	    	});
	});
	...
	<div id="ppb_live_preview_frame_wrapper" rel="ppb_preview_desktop">
		<iframe id="ppb_live_preview_frame" data-action="<?php echo esc_url(admin_url('admin-ajax.php?action=grandcarrental_ppb_preview_page_set_data')); ?>" data-preview="<?php echo esc_url($preview_url); ?>"></iframe>
	</div>
...
add_action('admin_menu', 'grandcarrental_content_create_meta_box'); 
?>