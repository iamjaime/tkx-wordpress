...
if(!empty($pp_advance_combine_css))
{
	...
	function grandcarrental_compress($buffer) {
	    //Remove CSS comments
	...
	ob_start("grandcarrental_compress");
}
?>
...
<?php
	...
	$current_browser = grandcarrental_get_browser();
...
<?php
	...
	{
		$tg_sidemenu_bg_arr = grandcarrental_hex_to_rgb($tg_sidemenu_bg);
?>
body .mobile_menu_wrapper
{
	background: rgba(<?php echo esc_attr($tg_sidemenu_bg_arr['r']); ?>, <?php echo esc_attr($tg_sidemenu_bg_arr['g']); ?>, <?php echo esc_attr($tg_sidemenu_bg_arr['b']); ?>, 0.85);
}
<?php
	}	
?>
